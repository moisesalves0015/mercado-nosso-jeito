...
import { Mail, Lock, User, ArrowLeft, Gem } from 'lucide-react';
...
export const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // New user goes straight to Home
      navigate('/');
    } catch (err: any) {
      console.error(err);
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            <label style={{ fontSize: '11.5px', fontWeight: 700, color: 'rgba(255, 255, 255, 0.6)' }}>Nome Completo</label>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
            <label style={{ fontSize: '11.5px', fontWeight: 700, color: 'rgba(255, 255, 255, 0.6)' }}>Confirmar Senha</label>
            <div style={{ position: 'relative' }}>
              <Lock size={16} color="rgba(255,255,255,0.4)" style={{ position: 'absolute', left: '12px', top: '50%', transform: 'translateY(-50%)' }} />
              <input
                type="password"
        ...
        <div style={{ marginTop: '24px', textAlign: 'center' }}>
          <span style={{ fontSize: '12.5px', color: 'rgba(255,255,255,0.5)' }}>Já tem uma conta? </span>
          <Link to="/login" style={{ fontSize: '12.5px', color: '#FFDF73', fontWeight: 800, textDecoration: 'none', marginLeft: '4px' }}>
            Faça login
          </Link>
        </div>
      </div>
