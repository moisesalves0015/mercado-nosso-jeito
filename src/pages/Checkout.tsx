...
import { AuthBackground, AuthStyles } from './Login';
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <button onClick={() => step === 'delivery' ? navigate('/cart') : setStep('delivery')} 
              style={{ background: 'var(--back-btn-bg)', border: '1px solid var(--border-primary)', borderRadius: '50%', width: 38, height: 38, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)', cursor: 'pointer' }}>
              <ArrowLeft size={18} />
            </button>
            <span style={{ fontWeight: 900, color: 'var(--text-primary)' }}>Checkout</span>
            <div style={{ width: 38 }} />
          </div>
        </div>
        ...
        <div style={{ padding: '20px 16px', maxWidth: 600, margin: '0 auto' }}>
          ...
          {step !== 'success' && (
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 30, padding: '0 20px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', opacity: step === 'delivery' ? 1 : 0.5 }}>
                <div style={{ width: 30, height: 30, borderRadius: '50%', background: step === 'delivery' ? '#D4AF37' : 'var(--input-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: step === 'delivery' ? '#000' : 'var(--text-secondary)', fontWeight: 'bold' }}>1</div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', opacity: step === 'payment' ? 1 : 0.5 }}>
                <div style={{ width: 30, height: 30, borderRadius: '50%', background: step === 'payment' ? '#D4AF37' : 'var(--input-bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: step === 'payment' ? '#000' : 'var(--text-secondary)', fontWeight: 'bold' }}>2</div>
          ...
          {step === 'delivery' && (
            <div className="checkout-step">
              ...
              <button 
                onClick={handleNext}
                style={{ width: '100%', marginTop: 24, padding: 16, borderRadius: 12, background: 'linear-gradient(135deg, #FFDF73, #D4AF37)', color: '#000', fontWeight: 'bold', border: 'none', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 8 }}
              >
          ...
          {step === 'payment' && (
            <div className="checkout-step">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                    ...
                    <span style={{ fontSize: 11, color: 'var(--text-secondary)' }}>Mock: Transação simulada</span>
                  </div>
                </button>
              </div>
              ...
              <button 
                ...
                disabled={loading}
                style={{ width: '100%', marginTop: 24, padding: 16, borderRadius: 12, background: 'linear-gradient(135deg, #FFDF73, #D4AF37)', color: '#000', fontWeight: 'bold', border: 'none', cursor: loading ? 'not-allowed' : 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 8, opacity: loading ? 0.7 : 1 }}
              >
                {loading ? 'Processando...' : <><ShieldCheck size={18} /> Finalizar Pedido</>}
              </button>
            </div>
          )}
